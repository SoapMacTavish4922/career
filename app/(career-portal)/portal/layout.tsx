...
export default function MainLayout({ children }: { children: ReactNode }) {
    ...
    const handleLogout = () => {
        setDropdownOpen(false);
        router.push("/login"); // replace with authService.logout()
    };
    ...
    return (
        <div className="flex min-h-screen bg-white">
                ...
                <div className="flex flex-col">
                    ...
                    <div className="h-16 flex items-center justify-center">
                        {collapsed ? (
                            ...
                            >
                                <img src="/menu.svg" alt="menu" className="w-4 h-4" />
                            </div>
                        ) : (
                            <Image
            ...
            <div className={`flex-1 flex flex-col transition-all duration-300 ${collapsed ? "ml-20" : "ml-64"}`}>
                ...
                {/* Topbar */}
                <header className="h-16 bg-white flex items-center justify-end px-6 border-b border-gray-100">
                    ...
                    <div className="relative" ref={dropdownRef}>
                        ...
                        >
                            ...
                            <div className="w-9 h-9 rounded-full bg-[#006256] flex items-center justify-center text-white text-xs font-bold shrink-0 ring-2 ring-transparent group-hover:ring-[#006256]/30 transition-all overflow-hidden">
                                {/* <img src={userPhotoUrl} className="w-full h-full object-cover" /> */}
                                JW
                            </div>
                        </button>
