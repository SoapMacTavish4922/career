            ...
            <div className="flex flex-col gap-8">
                ...
                <div className="flex flex-col gap-2">
                    ...
                    <div
                        ...
                        className={`min-h-[80px] border rounded-xl px-3 py-2.5 flex flex-wrap gap-2 cursor-text transition-all
                            ${skillError
                    ...
                    >
                        ...
                        {skills.map((skill, index) => (
                            <span
                                key={index}
                                className="flex items-center gap-1 bg-[#006256] text-white text-xs font-medium px-2.5 py-1 rounded-full"
                            >
                                {skill}
                                <button
                                    type="button"
